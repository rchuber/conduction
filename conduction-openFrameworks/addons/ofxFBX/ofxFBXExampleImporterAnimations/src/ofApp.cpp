...
void ofApp::setup() {
    ...
    //string filename = "Secondsong-30fps.fbx";
    //string filename = "samba_dancing.fbx";
    //string filename = "ofortuna2-centered.fbx";
    string filename = "secondsong-partiallycorrected.fbx";
